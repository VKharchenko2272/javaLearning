...
public class ExcellentPupil extends Pupil {
    @Override
    public void study() {
        System.out.println("study excellent pupil");
    }

    @Override
    public void read() {
        System.out.println("raad excellent pupil");
    }

    @Override
    public void write() {
        System.out.println("write excellent pupil");
    }

    @Override
    public void relax() {
        System.out.println("relax excellent pupil");
    }
}
